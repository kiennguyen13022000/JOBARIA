                ...
                <div class="col-12 col-lg-7">
                    <div class="mt-4 mt-lg-0 details_product_content">
                        <form action="" method="" class="details_product_form">
                            ...
                            <h3 class="product_title_modal mb-3">Janon vista fhd 4k</h3>
                            <p class="mb-3">Reference: demo 1</p>
                            ...
                            <div class="intro_modal mb-3 mt-3">Lorem ipsum dolor sit amet, consectetur
                                adipiscing
