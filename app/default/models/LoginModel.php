...
class LoginModel extends Model
{
    ...
    public function login($params){
        ...
        $query = "SELECT username, email, id, password, firstname, lastname, avatar FROM users WHERE username='$username' and password='$password' and `status` = 1 and is_Admin = 0";
