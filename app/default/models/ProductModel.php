...
class ProductModel extends Model
{
    ...
    public function other_products($product_id, $category_id){
        $query = 'SELECT id,image,slug,product_name,price,category_id,is_new,promotion,promotion_end_date FROM products WHERE status=1 and category_id='.$category_id.' and id!='.$product_id.' limit 0,12';
        $result = $this->ListRecord($query);
        return  $result;
    }
